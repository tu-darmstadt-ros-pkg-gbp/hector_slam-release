## hector_slam (noetic) - 0.5.2-4

The packages in the `hector_slam` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release hector_slam --ros-distro noetic` on `Mon, 12 Apr 2021 17:51:56 -0000`
...
## hector_slam (noetic) - 0.5.2-3

The packages in the `hector_slam` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release hector_slam --ros-distro noetic` on `Mon, 12 Apr 2021 17:47:08 -0000`
...
## hector_slam (noetic) - 0.5.2-2

The packages in the `hector_slam` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release hector_slam --rosdistro noetic` on `Thu, 08 Apr 2021 16:59:06 -0000`
...
## hector_slam (noetic) - 0.5.2-1

The packages in the `hector_slam` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release hector_slam --rosdistro noetic` on `Thu, 08 Apr 2021 16:21:02 -0000`
...
## hector_slam (noetic) - 0.5.1-1

The packages in the `hector_slam` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release hector_slam --rosdistro noetic` on `Fri, 15 Jan 2021 12:27:34 -0000`
...
The packages in the `hector_slam` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --track indigo --rosdistro indigo hector_slam` on `Fri, 24 Jun 2016 20:15:28 -0000`
